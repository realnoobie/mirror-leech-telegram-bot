...
class _BotCommands:
    def __init__(self):
        ...
        self.MirrorCommand = f'mirrorkoreantvshows{CMD_INDEX}'
        ...
        self.LeechCommand = f'leechkoreantvshows{CMD_INDEX}'
